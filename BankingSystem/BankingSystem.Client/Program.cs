            ...
            do
            {
                ...
                switch (input)
                {
                    case 1:
                        ...
                        var task = GetApi("api/Account/" + 100);
                        task.Wait();
                    ...
                    case 2:
                        ...
                        var taskD = CallPostApi("api/Account/" + postData.AccountNumber + "/Deposit", postData);
                        taskD.Wait();
                    ...
                    case 3:
                        ...
                        var taskW = CallPostApi("api/Account/" + postDataW.AccountNumber + "/Withdraw", postDataW);
                        taskW.Wait();
